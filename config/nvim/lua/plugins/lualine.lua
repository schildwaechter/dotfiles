    ...
    require("lualine").setup({
      ...
      sections = {
        ...
        lualine_c = {
                ...
                cond = function()
                     return vim.tbl_contains({ "yaml", "helm", "yaml.compose", "yaml.gitlab-ci", "json", "json5", "jsonc", "toml" }, vim.api.nvim_get_option_value("ft", { buf = 0 })) -- it's the right file format
                     and package.loaded["schema-companion"] ~= nil  -- check it's loaded
