...
return {
  ...
  config = function()
    ...
    local servers = {
      ...
      gopls = {},
      -- for python we use ruff with pylsp on top
      ruff = {},
      pylsp = {},
      dockerls = {},
      terraformls = {},
    ...
    vim.list_extend(ensure_installed, {
      ...
      -- the following have their own setup files
      "yamlls", -- YAML LSP server, installed via mason-lspconfig but configured seperately
    })
    ...
    --         vim.lsp.config(server_name).setup(require("schema-companion").setup_client(server))
    ...
    --               log_level = "trace",
    --               load_langs = { "en-GB", "de-DE", "no-NB" },
    --               path = vim.fn.expand("~") .. "/.dotsecrets/ltex",
    --             })
    --           end,
    --           settings = { ltex = server },
    --           ft = server.filetypes,
    --         })
    --       else
